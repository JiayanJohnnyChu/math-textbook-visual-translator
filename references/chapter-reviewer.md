...
- missing titles, paragraphs, formulas, proof steps, lists, author footnotes, captions, or blank pages;
- summarized, compressed, paraphrased, modernized, or substituted proofs;
- signs, arrows, subscripts, superscripts, dots, primes, integration domains, piecewise conditions, index ranges, and endpoint conditions;
- theorem and equation numbering, footnotes, and cross-references;
...
- Make a local correction to the chapter only when direct visual evidence supports it.
